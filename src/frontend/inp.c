        ...
        */
        if (subcktname) {
            ...
            if (ciprefix(".subckt", curr_line)) {
                curr_line = skiptok(curr_line); /* skip .subckt */
                    ...
                    if (found) {
                        ...
                        for (xx = mc_deck->li_next; xx; xx = xx->li_next) {
                            ...
                            if (*xline == 'x') {
                                ...
                                if (xline) {
                                    xline = skiptok(xline); /* skip subcktname */
                                    int ii;
                                    for (ii = 0; ii < notok; ii++)
                                        xline = skiptok(xline); /* skip parameter values */
                                    char *beg = copy_substring(xx->li_line, xline);
                                    xline = skiptok(xline); /* skip parameter value to be replaced */
        ...
        /* alterparam pname=vpval */
            ...
            if (ciprefix(".param", curr_line)) {
                curr_line = skiptok(curr_line); /* skip .param */
